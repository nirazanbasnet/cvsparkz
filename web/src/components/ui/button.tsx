...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      // which renders an <a>), Base UI must not assume a native <button> or it
      // warns and drops button semantics. Default nativeButton to false in that
      // case; an explicit nativeButton prop always wins.
